<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <!--<li class="nav-item">
                        <a class="nav-link" href="#" ><i class="fa fa-suitcase"></i> Pedidos</a>
                    </li>-->
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{url('admin/usuario')}}" onclick="event.preventDefault(); document.getElementById('usuario-form').submit();"><i class="fa fa-tasks"></i> Usuario</a>
                <form id="usuario-form" action="{{url('admin/usuario')}}" method="GET" style="display: none">
                    {{csrf_field()}}
                </form>
            </li>
